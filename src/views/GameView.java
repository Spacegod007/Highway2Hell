...
public class GameView extends Application
{
    ...
    public GameView(IGameAdmin game, IRemotePublisherForListener rpl, User user)
    {
    ...
    public void start(Stage primaryStage, List<User> userList, Scene scene, LobbyView application) throws Exception {
